...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_smooth_focal', full_name='second.protos.ClassificationLoss.weighted_smooth_focal', index=6,
...
_SOFTMAXFOCALCLASSIFICATIONLOSSSMOOTHING = _descriptor.Descriptor(
  name='SoftmaxFocalClassificationLossSmoothing',
  full_name='second.protos.SoftmaxFocalClassificationLossSmoothing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='second.protos.SoftmaxFocalClassificationLossSmoothing.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='second.protos.SoftmaxFocalClassificationLossSmoothing.gamma', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alpha', full_name='second.protos.SoftmaxFocalClassificationLossSmoothing.alpha', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='smooth', full_name='second.protos.SoftmaxFocalClassificationLossSmoothing.smooth', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIFICATIONLOSS.fields_by_name['weighted_smooth_focal'].message_type = _SOFTMAXFOCALCLASSIFICATIONLOSSSMOOTHING
...
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
  _CLASSIFICATIONLOSS.fields_by_name['weighted_smooth_focal'])
_CLASSIFICATIONLOSS.fields_by_name['weighted_smooth_focal'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name['classification_loss']
...
DESCRIPTOR.message_types_by_name['SoftmaxFocalClassificationLossSmoothing'] = _SOFTMAXFOCALCLASSIFICATIONLOSSSMOOTHING
...
SoftmaxFocalClassificationLossSmoothing = _reflection.GeneratedProtocolMessageType('SoftmaxFocalClassificationLossSmoothing', (_message.Message,), {
  'DESCRIPTOR' : _SOFTMAXFOCALCLASSIFICATIONLOSSSMOOTHING,
  '__module__' : 'second.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:second.protos.SoftmaxFocalClassificationLossSmoothing)
  })
_sym_db.RegisterMessage(SoftmaxFocalClassificationLossSmoothing)
