...
_INPUTREADER_DATASET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_reduced', full_name='second.protos.InputReader.Dataset.is_reduced', index=3,
...
_INPUTREADER_PREPROCESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_bg_filter', full_name='second.protos.InputReader.Preprocess.random_bg_filter', index=22,
