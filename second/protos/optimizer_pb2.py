...
_OPTIMIZER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='radam_optimizer', full_name='second.protos.Optimizer.radam_optimizer', index=3,
...
_RADAMOPTIMIZER = _descriptor.Descriptor(
  name='RAdamOptimizer',
  full_name='second.protos.RAdamOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='second.protos.RAdamOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_decay', full_name='second.protos.RAdamOptimizer.weight_decay', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPTIMIZER.fields_by_name['radam_optimizer'].message_type = _RADAMOPTIMIZER
...
_OPTIMIZER.oneofs_by_name['optimizer'].fields.append(
  _OPTIMIZER.fields_by_name['radam_optimizer'])
_OPTIMIZER.fields_by_name['radam_optimizer'].containing_oneof = _OPTIMIZER.oneofs_by_name['optimizer']
...
_RADAMOPTIMIZER.fields_by_name['learning_rate'].message_type = _LEARNINGRATE
...
DESCRIPTOR.message_types_by_name['RAdamOptimizer'] = _RADAMOPTIMIZER
...
RAdamOptimizer = _reflection.GeneratedProtocolMessageType('RAdamOptimizer', (_message.Message,), {
  'DESCRIPTOR' : _RADAMOPTIMIZER,
  '__module__' : 'second.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:second.protos.RAdamOptimizer)
  })
_sym_db.RegisterMessage(RAdamOptimizer)
